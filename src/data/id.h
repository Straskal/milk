...
namespace milk {
	...
	namespace id {
		u32 make(IdData& data, const u32 GENERATION_BITS, const int MAX_FREE_INDECES);
		void recycle(IdData& data, const u32 GENERATION_BITS, u32 id);
		bool valid(const IdData& data, const u32 GENERATION_BITS, const u32 INDEX_BITS, u32 id);
	}
}
