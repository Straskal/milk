...
milk::u32 milk::id::make(UID* data, u32 GENERATION_BITS, u32 MAX_FREE_INDECES)
{
	u16 index;
...
void milk::id::recycle(UID* data, u32 GENERATION_BITS, u32 id)
{
...
bool milk::id::valid(const UID* data, u32 GENERATION_BITS, u32 INDEX_BITS, u32 id)
{
	u16 index = id & ~(1 << GENERATION_BITS);
