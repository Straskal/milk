...
milk::u32 milk::id::make(milk::UidData* data, milk::u32 GENERATION_BITS, int MAX_FREE_INDECES)
{
	u16 index;
...
void milk::id::recycle(milk::UidData* data, milk::u32 GENERATION_BITS, milk::u32 id)
{
...
bool milk::id::valid(const milk::UidData* data, u32 GENERATION_BITS, u32 INDEX_BITS, milk::u32 id)
{
	u16 index = id & ~(1 << GENERATION_BITS);
