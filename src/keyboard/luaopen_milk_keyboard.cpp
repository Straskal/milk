...
static const milk::luaM_Enum lua_keys_enum[] = {
	...
	{ "UP", (int)milk::keys::UP },
	{"NUMLOCK", (int)milk::keys::NUMLOCK},
	{"KPDIVIDE", (int)milk::keys::KPDIVIDE},
	{"KPMULTIPLY", (int)milk::keys::KPMULTIPLY},
	{"KPMINUS", (int)milk::keys::KPMINUS},
	{"KPPLUS", (int)milk::keys::KPPLUS},
	{"KPENTER", (int)milk::keys::KPENTER},
	{"KPNUM1", (int)milk::keys::KPNUM1},
	{"KPNUM2", (int)milk::keys::KPNUM2},
	{"KPNUM3", (int)milk::keys::KPNUM3},
	{"KPNUM4", (int)milk::keys::KPNUM4},
	{"KPNUM5", (int)milk::keys::KPNUM5},
	{"KPNUM6", (int)milk::keys::KPNUM6},
	{"KPNUM7", (int)milk::keys::KPNUM7},
	{"KPNUM8", (int)milk::keys::KPNUM8},
	{"KPNUM9", (int)milk::keys::KPNUM9},
	{"KPNUM0", (int)milk::keys::KPNUM0},
	{"KPPERIOD", (int)milk::keys::KPPERIOD},
