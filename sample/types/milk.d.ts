...
declare function spr(index: number, x: number, y: number, width?: number, height?: number, scale?: number, flip?: 0 | 1 | 2 | 3): void;
...
declare function playstream(index: 0 | 1, volume: number, loop?: boolean): void;
