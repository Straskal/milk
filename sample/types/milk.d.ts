...
declare function spr(spriteId: number, x: number, y: number, width?: number, height?: number, scale?: number, flip?: 0 | 1 | 2 | 3, color?: number, mode?: 0 | 1 | 2): void;
declare function font(fontId: number, x: number, y: number, text: string, scale?: number, color?: number): void;
