...
declare function openstream(streamId: 0 | 1, filePath: string): void;
declare function playstream(streamId: 0 | 1, volume: number, loop?: boolean): void;
declare function stopstream(): void;
declare function pausestream(): void;
declare function resumestream(): void;
declare function closestream(streamId: 0 | 1): void;
